...
(S/N)
 a| 
Activa la gestión de archive log
para eliminar los archive logs.
...
.. En la columna Configure Schedules, haga clic en image:../media/add_policy_from_resourcegroup.gif["añada una política desde el grupo de recursos"] en la política que desea configurar.
