...
+
Para obtener más información sobre cmdlets de Windows, consulte https://docs.netapp.com/us-en/snapcenter-cmdlets-49/index.html["Guía de referencia de cmdlet"^].
...
image::../media/snapcenter_architecture.gif[Arquitectura de SnapCenter]
