...
+
Puede buscar el grupo de recursos escribiendo el nombre en el cuadro de búsqueda o haciendo clic en image:../media/filter_icon.gif["icono de filtro"] y seleccionado la etiqueta. A continuación, puede hacer clic image:../media/filter_icon.gif["icono de filtro"]en [] para cerrar el panel de filtros.
