...
Después de completar el mantenimiento del host, puede sacar el host del modo de mantenimiento haciendo clic en *Activar programa*.
Puede activar la programación de varios hosts al mismo tiempo.
