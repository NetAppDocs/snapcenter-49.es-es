...
Las configuraciones compatibles con el plugin de SnapCenter para base de datos de Oracle se enumeran en la https://imt.netapp.com/matrix/imt.jsp?components=112391;&solution=1259&isHWU&src=IMT["Herramienta de matriz de interoperabilidad de NetApp"^].
